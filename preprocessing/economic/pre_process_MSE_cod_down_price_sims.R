...
# 
here::i_am("preprocessing/economic/pre_process_MSE_cod_down_price_sims.R")
...
output_price_loc<-paste0(file_prefix,"adj_cod_down_price_series.dta")
output_preoutfile<-paste0(file_prefix,"adj_pre_cod_down_price_series.Rds")
output_postoutfile<-paste0(file_prefix,"adj_post_cod_down_price_series.Rds")
